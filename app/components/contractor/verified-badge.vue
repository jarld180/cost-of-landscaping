...
export type VerificationTier = 'trusted_partner' | 'fully_verified' | 'basic_verified'
...
<template>
  <div
    :class="['inline-flex items-center justify-center gap-1.5 rounded-full px-3 py-1', config.bg]"
  >
    <svg
    ...
    <span :class="['text-sm font-semibold', config.color]">{{ config.label }}</span>
  </div>
</template>
